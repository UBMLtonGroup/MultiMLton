...
structure GCField =
   struct
      ...
      val sharedFrontierOffset: Bytes.t ref = ref Bytes.zero
      ...
      fun setOffsets {atomicState, cardMapAbsolute, currentThread, curSourceSeqsIndex,
                      exnStack, ffiOpArgsResPtr, frontier, sharedFrontier, globalObjptrNonRoot, 
		      limit, limitPlusSlop, localHeapStart, maxFrameSize, procId, returnToC,
	  ...
	  ; sharedFrontierOffset := sharedFrontier
	  ...
	  | SharedFrontier => !sharedFrontierOffset
      ...
      val sharedFrontierSize: Bytes.t ref = ref Bytes.zero
	  ...
	  ; sharedFrontierSize := sharedFrontier
	  ...
	  | SharedFrontier => !sharedFrontierSize
